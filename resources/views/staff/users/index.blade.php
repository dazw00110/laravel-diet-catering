        ...
        @forelse ($users as $user)
            <tr>
                ...
                <td class="p-2 border-b text-center">
                    {!! $user->is_vegetarian ? '<span class="text-purple-600 font-bold">✔</span>' : '<span class="text-gray-400">–</span>' !!}
                </td>
                <td class="p-2 border-b text-center">
                    {!! $user->is_vegan ? '<span class="text-purple-600 font-bold">✔</span>' : '<span class="text-gray-400">–</span>' !!}
                </td>
