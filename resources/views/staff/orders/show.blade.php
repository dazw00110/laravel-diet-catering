...
<div class="max-w-4xl mx-auto py-10">
    ...
    <div class="mt-6 flex gap-4">
        <a href="{{ route('staff.orders.index') }}" class="bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-400">← Powrót do listy</a>
        <a href="{{ route('staff.orders.edit', $order->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">✏️ Edytuj zamówienie</a>
    </div>
</div>
@endsection
